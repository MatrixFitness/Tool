...
# Build 023: install critical tools before recovery
...
# Build 023 unified ZeroTier runtime library
...
# Build 023 - install self-healing Doctor before recovery validation.
