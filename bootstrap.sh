...
# Build 022: install critical tools before recovery
...
# Build 022 unified ZeroTier runtime library
...
# Build 022 - install self-healing Doctor before recovery validation.
