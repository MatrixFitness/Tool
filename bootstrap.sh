...
# Build 024: install critical tools before recovery
...
# Build 024 unified ZeroTier runtime library
...
# Build 024 - install self-healing Doctor before recovery validation.
