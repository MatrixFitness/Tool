...
# Build 026: install critical tools before recovery
...
# Build 026 unified ZeroTier runtime library
...
# Build 026 - install self-healing Doctor before recovery validation.
