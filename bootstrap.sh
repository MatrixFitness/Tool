...
# Build 028: install critical tools before recovery
...
# Build 028 unified ZeroTier runtime library
...
# Build 028 - install self-healing Doctor before recovery validation.
