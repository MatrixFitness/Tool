...
# Build 030 Smart ZeroTier handling
SMART_ZT_SRC=""
for CANDIDATE in \
...
# Build 030: install critical tools before recovery
...
# Build 030 unified ZeroTier runtime library
...
# Build 030 - install self-healing Doctor before recovery validation.
...
log "
# Build 030 Admin Authentication Recovery
