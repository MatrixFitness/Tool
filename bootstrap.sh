...
# Build 025: install critical tools before recovery
...
# Build 025 unified ZeroTier runtime library
...
# Build 025 - install self-healing Doctor before recovery validation.
