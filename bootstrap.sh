...
# Build 032 Smart ZeroTier handling
SMART_ZT_SRC=""
for CANDIDATE in \
...
# Build 032: install critical tools before recovery
...
# Build 032 unified ZeroTier runtime library
...
# Build 032 - install self-healing Doctor before recovery validation.
...
# Build 032 install all runtime libraries
...
log "
# Build 032 Admin Authentication Recovery
